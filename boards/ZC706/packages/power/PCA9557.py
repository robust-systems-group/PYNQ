...
#############################################
# class to handle the PCA9557 gpio expander
############################################
...
class PCA9557:
    """ This class is used to program PCA9557 """

    def __init__(self, portNum, busAddr, initialDirectionMask = 0x0, initialOutput=0x0, initialPolarity=0x0):
        # control register addresses
        self.INPUT_REG = 0
        self.OUTPUT_REG = 1
        self.POLARITY_INVRSN_REG = 2
        self.CONFIG_REG = 3
        ...
        self.write_output_reg(initialOutput)                   # Setting initial output values        self.write_polarity_reg(initialPolarity)              # Setting initial polarity
        self.write_polarity_reg(initialPolarity)              # Setting initial polarity
        self.write_config_reg(initialDirectionMask)            # Setting initial pin directions
        logging.debug('{} {} {} {} {}'.format("PCA9557 expander on port ", self.portNum, " with address ", self.busAddr, " initialized"))
